...
if(isset($_GET['id'])){
	$user = $conn->query("SELECT * FROM tblblooddonars where id =".$_GET['id']);
...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$status = 1;
		$sql = "UPDATE  tblblooddonars SET FullName=:fullname,MobileNumber=:mobile,EmailId=:email,BirthDay=:bday,Age=:age,Gender=:gender,BloodGroup=:blodgroup,Purok=:purok,Barangay=:barangay,Message=:message,status=:status";
...
?>
	...
	<head>
		...
		<title>BBDMS| Admin Update Donor</title>
								...
								<div class="col-md-12">
									<div class="panel panel-default">
										...
										<div class="panel-body">
											<form method="post" class="form-horizontal" id="update-user" enctype="multipart/form-data">
												<div class="form-group">
													<label class="col-sm-2 control-label">Full Name<span style="color:red">*</span></label>
													<div class="col-sm-4">
														<input type="text" name="fullname" placeholder="First Name  Middle Name. Last Name" class="form-control" value="<?php echo htmlentities($result->FullName); ?>" required>
													</div>
