			...
			<div id="reloadable">
				<table id="example" class="display" style="width:100%">
					...
					<tbody id="test">
						...
						<td>
							<a href="manage-bloodgroup2.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-trash text-secondary"></i></a>
				...
				<div class="modal-body">
					<form action="/action_page.php">
						<div class="form-group">
							<label for="bGroup">Blood Type:</label>
				...
				<div class="modal-body">
					<form action="/action_page.php">
						<div class="form-group">
							...
							<input type="text" class="form-control" id="names" name="uname" required />
  ...
  <script>
   ...
   $(document).ready(function () {
		...
		$('#btnAdd').click(function (e) { 
			e.preventDefault();
			var data = $('#bGroup').val();
      		var url = 'xhr/add-bloodgroups.php';
			$.ajax({
				type: "GET",
				url: url,
