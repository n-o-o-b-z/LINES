...
?>
    ...
    <ul>
        <li>LIFELINE blood donation Web app aims to connect people who want to express interest in donating blood with blood camps voluntarily and blood requesters in emergencies in their geographical area that are seeking blood donors and allows people who
            use the Web app ("Users") to sign-up, to receive notifications from LIFELINE about blood donation opportunities near them. The donation app can also connect Users with people and non-Blood Bank organizations in the User's geographical area
            ("Donees"). Here are more details about the terms of service for the LIFELINE Web app Feature (the "Terms") upon which Users and Barangay Healthcare Centers, Rural Healthcare Centers, and Hospitals may use the LIFELINE Web app.</li>
    </ul>
</p>
...
<p>
    ...
    <ul>
        <li>Blood donation is a voluntary service, and LIFELINE does not guarantee that a person or User will agree to donate blood whenever called upon. Users may opt out of receiving notifications at any time. Users and Hospitals have the right to stop
            participating in this Web app at any time.
        </li>
        <li>
...
<p>
    ...
    <ul>
        <li>When providing the Web app, LIFELINE does not engage with RHU, and Hospital activities and does not arrange blood donors. LIFELINE only facilitates contact between people, including Users, with BHW, RHU, and Hospitals in need of blood, providing
            relevant information about the organizations and those in need of blood to potential blood donors.</li>
        <li>LIFELINE is not responsible for the contact made between users, including Users, BHW, RHU, and Hospitals, nor is LIFELINE accountable for the User's or the organizations' actions before or after contact is made. LIFELINE is not responsible for
            any misuse of the contact information displayed. LIFELINE gives no assurance concerning the authenticity, accuracy, or correctness of the information provided by the User or the organization behind their activities. The people using the Web
            app, including Users, and the BHW, RHU, and Hospitals, are responsible for verifying the information provided by the others.</li>
        ...
        <li>LIFELINE will not, to the extent permitted under Applicable Law, be responsible for any claims, disputes, suits, actions, proceedings, losses, injury, damages, or harm (including, but not limited to, loss of personal data, personal injury, or
            loss of life) caused to the User, the Organizations, or any third party due to any interaction between people using the Web app, including Users, Organizations, or any third party.</li>
    </ul>
</p>
...
<p>
    ...
    <ul>
        <li>
            You may opt-out of the Web app as a User and stop receiving updates at any time through your LIFELINE profile. Blood donation is voluntary, and it is your discretion to donate blood.</li>
    </ul>
</p>
...
<p>
    ...
    <ul>
        ...
        <li>
            When you register as RHU or Hospital for the Feature, you express an interest in connecting with potential blood donors in your geographic regions. You agree that LIFELINE may share your interest through this Web app Feature. You may also use this feature
            to create posts and events/announcements on LIFELINE.
        </li>
    </ul>
...
<p>
    ...
    <ul>
        <li>
            LIFELINE does not conduct any independent health or background checks. LIFELINE cannot certify that any person, including a User, will be free from any disease or medical conditions preventing the person from donating blood when the Donor contacts the
            RHU or Hospital.
        </li>
        <li>
        ...
        <li>
            RHU, Hospitals, and Donor's agree to provide LIFELINE upon request with anonymous or aggregated level data relating to the number of Donors who came to them through the LIFELINE Web app.
        </li>
    </ul>
</p>
