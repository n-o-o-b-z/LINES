...
<head>
    ...
    <title>LIFE_LINE | Search Donor</title>
                        ...
                        <div class="col-lg-4 col-sm-6 portfolio-item">
                            <div class="card h-100">
                                ...
                                <div class="card-block">
                                    ...
                                    <p class="card-text"><b>Mobile No:&nbsp;</b><a href="tel:<?php echo htmlentities($result->MobileNumber); ?>"><?php echo htmlentities($result->MobileNumber); ?></a>
                                    <p class="card-text"><b>Email:</b><a href="mailto:<?php echo htmlentities($result->MobileNumber); ?>">
                                    ...
                                    <p class="card-text"><b> BirthDay:</b> <?php echo htmlentities($result->BirthDay); ?></p>
                                    <p class="card-text"><b>Blood Group :</b> <?php echo htmlentities($result->BloodGroup); ?></p>
                                    <p class="card-text"><b>Purok :</b>
                                        <?php if ($result->Purok == "") {
                                            echo htmlentities('NA');
                                        } else {
                                            echo htmlentities($result->Purok);
                                        }
                                        ?></p>
                                    <p class="card-text"><b>Barangay :</b>
                                        <?php if ($result->Barangay == "") {
                                            echo htmlentities('NA');
                                        } else {
                                            echo htmlentities($result->Barangay);
                                        }
                                        ?></p>
