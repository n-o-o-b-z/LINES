												...
												<div class="form-group">
													<div class="col-sm-8">
														<select name="menu1" onChange="MM_jumpMenu('parent',this,0)">
															...
															<!-- <option value="manage-page.php?type=aboutus">About Us</option> -->
															<!-- <option value="manage-page.php?type=announcement">Announcement</option> -->
															<option value="manage-page.php?type=needforblood">The need for blood</option>
															<option value="manage-page.php?type=bloodtips">Blood Tips</option>
															<option value="manage-page.php?type=whocouldyouhelp">Who you could Help</option>
														</select>
													</div>
												</div>
